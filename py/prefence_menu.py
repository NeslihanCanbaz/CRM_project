...
"")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.applicationsButton.setFont(font)
...
"background-color: rgb(255, 255, 255);")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.mentorMeetingButton.setFont(font)
        ...
        brush = QtGui.QBrush(QtGui.QColor(91, 93, 255))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        ...
        self.interviewButton.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
